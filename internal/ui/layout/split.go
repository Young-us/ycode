...
// SplitPaneLayout manages up to 3 panels with configurable ratios
...
// SplitPaneOption configures a split pane layout
...
// NewSplitPane creates a new split pane layout with the given options
